...
def relogio():
    ...
    dia_label["text"] = dia_str + "/" + mes_str
...
mes_label = Label(
    ...
    bg=cor3, 
    highlightthickness=0)
mes_label.place(x=-10, y=100, anchor='nw')
...
nome_dia_label.place(x=10, y=10)
